...
def build_app():
    model_choices = ['efficientnet_v2_s', 'convnext_tiny', 'custom_cnn']
    ...
    with gr.Blocks(
        ...
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                model_dropdown = gr.Dropdown(
                    ...
                    label='Model',
                    info='EfficientNetV2-S and ConvNeXt-Tiny use transfer learning; '
                         'Custom CNN is trained from scratch.',
                )
                run_btn = gr.Button('Analyse ▶', variant='primary')

                _example_names = ["001-018.png","001-033.png","001-034.png","001-042.png",
                                  "001-056.png","001-065.png","001-137.png","001-148.png","001-154.png"]
                _example_paths = [p for p in _example_names
                ...
                # If no sample images were uploaded to the Space, the
                # Examples block is skipped entirely rather than crashing
                # the app on a missing-file error at startup.
        ...
        gr.Markdown(
            ...
            Ten Fabrics Dataset · EfficientNetV2-S · ConvNeXt-Tiny · Custom CNN · PyTorch
            </div>
            """,
        )
